package org.matterhorn.engage.streaming;
...
public class DemoService {
	...
	private static Logger log = Red5LoggerFactory.getLogger(DemoService.class, "engage");
	
	{
		log.info("engage streaming DemoService created");
	}
